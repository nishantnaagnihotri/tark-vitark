...
5. Block progression when UX coverage is incomplete or inconsistent with the PRD.
...
5. Produce a handoff package that can drive Figma design and later design QA.
...
8. `UX Flow/State Package`: consolidated artifact for Figma handoff.
...
8. Traceability snapshot to PRD requirements.
