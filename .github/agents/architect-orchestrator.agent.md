...
8. DO NOT execute `gh pr merge` without explicit PR-level authorization: Product Owner must name the PR number and state merge intent. Ambiguous acknowledgments ("ok", "proceed", "go ahead") are not sufficient.
