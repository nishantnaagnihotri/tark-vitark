...
| Gate 3A — UX | 03-ux.md | [View](https://github.com/nishantnaagnihotri/tark-vitark/blob/master/docs/slices/{slice-name}/03-ux.md) |
| Gate 3C — Design QA | 04-design-qa.md | [View](https://github.com/nishantnaagnihotri/tark-vitark/blob/master/docs/slices/{slice-name}/04-design-qa.md) |
| Gate 4 — Architecture | 05-architecture.md | [View](https://github.com/nishantnaagnihotri/tark-vitark/blob/master/docs/slices/{slice-name}/05-architecture.md) |
| Gate 4 End — Tasks | 06-tasks.md | [View](https://github.com/nishantnaagnihotri/tark-vitark/blob/master/docs/slices/{slice-name}/06-tasks.md) |
