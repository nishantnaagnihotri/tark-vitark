...
**can proceed to design-qa** — All 14 frames are in Figma section `832:452`. Source of truth: `docs/slices/create-debate/03-ux.md`. Acceptance criteria: AC-29–AC-40 from `02-prd.md`. Dispatch trigger owned by orchestrator.
