...
- **TV icon (M3 Material Symbols `tv` SVG native):** Required for Phase 1. SVG vector construction via `figma.createNodeFromSvg()`. Fill is bound to `color/brand/primary` with confirmed variable ID `VariableID:9:2`. ✅
