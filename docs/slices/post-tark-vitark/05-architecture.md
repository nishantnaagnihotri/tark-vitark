...
| AD-8 | Desktop Podium responsive spec | Full-width with 120px side inset | `--podium-inline-padding: var(--space-30)` at `min-width: 1024px` | Figma `582:50` uses `px-[120px]` and `w-full`; original `max-width: 600px` spec was authored from text, not Figma frame — corrected 2026-04-16 |
