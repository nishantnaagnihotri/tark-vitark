...
| AC-20 | Tapping the collapsed FAB expands it with M3 animation (300 ms ease-out) to show Tark and Vitark side-select options. *(Amended at Gate 5.5 — PO approved two-tap side-select UX: tapping FAB expands side-select options; tapping a side opens the bottom-sheet composer with that side pre-selected; 2026-04-20)* |
